...
class EducationController extends Controller
{
	...
	public function fetchAll() {
		$emps = Education::with('education_category')->get();
		$output = '';
		if ($emps->count() > 0) {
			...
			foreach ($emps as $emp) {
				$output .= '<tr>';
                if ($emp->file) {
                    $output .= '<td><img src="../storage/edukasi/' . $emp->file . '" height="50" width="50" class="img-fluid img-thumbnail"></td>';
                } else {
                    $output .= '<td><img src="../img/no-image.png" height="50" width="50" class="img-fluid img-thumbnail"></td>';
                }
