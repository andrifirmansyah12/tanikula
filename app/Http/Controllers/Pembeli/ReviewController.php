            ...
            if ($orders->count() > 0) {
                ...
                $output .= '<div class="border-bottom mb-2 pb-2">
                    ...
                    $output .= '<div class="d-flex align-items-center pt-3">';
                        ...
                        $output .= '<img src="../img/user.png" class="rounded-circle shadow-sm" style="border: 1px solid #16A085; width: 55px; height: 55px; -o-object-fit: cover; object-fit: cover; -o-object-position: center; object-position: center;" alt="'. $userInfo->user->name .'">';
                        }
                        $output .= '<div>
