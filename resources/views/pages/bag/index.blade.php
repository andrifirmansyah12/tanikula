                    ...
                    <div class="d-lg-flex mb-5 gap-lg-2 gap-xl-0">
                                                ...
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-12 col-md-6 mt-2 ms-md-3 mt-md-0">
                                                        ...
                                                        @if ($item->product->price_discount)
                                                            <span
                                                                class="text-decoration-line-through text-muted text-danger"
                                                                style="font-size: 13px">Rp.
                                                                {{ number_format($item->product->price_discount, 0) }}
                        ...
                        <div class="mt-lg-4 mt-xl-0 col-12 col-lg-4 d-none d-sm-block">
                            <div class="m-0 m-xl-4 p-4 rounded" style="border: 1px solid #16A085;">
                                ...
                                <div class="d-flex mb-8 align-items-center justify-content-between pb-3"
                                ...
                                @if ($cartItem->count())
                                    <button type="submit" class="btn w-100 text-uppercase text-white"
                                        style="background: #16A085;" href="{{ url('cart/shipment') }}">Checkout (<span
                                            class="beli-keranjang-count">0</span>)</a>
                                    @else
                                        <a class="btn w-100 text-uppercase text-white" style="background: #16A085;"
                                    ...
                                    <div class="d-flex align-items-center justify-content-end">
                                        ...
                                        @if ($cartItem->count())
                                            <button type="submit" class="btn text-capitalize text-white"
                                                ...
                                                href="{{ url('cart/shipment') }}">Checkout(<span
                                                    class="beli-keranjang-count">0</span>)</a>
                                            @else
                    ...
                    <div class="m-4">
                        ...
                        <div class="owl-carousel owl-theme">
                            @foreach ($product_new as $item)
                                ...
                                <div class="mx-2 single-product shadow-none {{ $item->stoke == 0 ? 'bg-light opacity-90' : '' }}"
                                    style="height: 27rem; border: 1px solid #16A085;">
                                    ...
                                    <div class="product-info {{ $item->stoke == 0 ? 'bg-light opacity-90' : '' }}"">
                                        @if ($item->discount != 0)
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <p class="small category text-white badge bg-danger">
                                                    {{ $item->discount }}% OFF</p>
                                            </div>
                                        @else
                                            <a href="{{ url('product-category/' . $item->product_category->slug) }}">
                                            ...
                                            @if ($item->price_discount)
                                                <span class="text-decoration-line-through text-muted "
                                                    ...
                                                    {{ number_format($item->price_discount, 0) }} <span
                                                        style="color: #16A085">Rp.
                                                        {{ number_format($item->price, 0) }}</span></span>
                                            @else
                                                <span style="color: #16A085">Rp.
