                            ...
                            <div class="top-end">
                                ...
                                @else
                                    <ul class="user-login d-none d-md-block">
                                        ...
                                        <li>
                                            <div class="dropdown">
                                                <a style="cursor: pointer; background: #16A085; color: #ffff;"
                                                    class="btn" data-toggle="dropdown" aria-expanded="false">Daftar</a>
                            ...
                            <form action="{{ url('/search-product') }}">
                                <div class="navbar-search search-style-5">
                                    <div class="search-input">
                                        <input type="search" style="border: 1px solid #16A085;"
                                            class="form-control typeaheadProduct" value="{{ request('pencarian') }}"
                                            name="pencarian" placeholder="Pencarian produk" autocomplete="off">
                                    </div>
                            ...
                            <div class="navbar-cart">
                                <div class="notification-items">
                                    @php
                                        ...
                                        $notifications = App\Models\PushNotification::where('user_id', Auth::id())
                                            ->latest()
                                            ->get();
                                    @endphp
                                    ...
                                    <div class="shopping-item">
                                        ...
                                        <ul class="shopping-list"
                                            id="{{ $notifications->count() > 1 ? 'style-1' : '' }}">
                                                ...
                                                @foreach ($cartItem as $item)
                                                    <div class="d-flex navbarCheckProductCart">
                                                        <input class="form-check-input" type="checkbox"
                                                            name="navbar_cart_id[]" value="{{ $item->id }}"
                                                            id="navbarCheckProductCart">
                                                        <input class="form-check-input" type="hidden"
                                                            name="navbar_cart_qty" value="{{ $item->product_qty }}"
                                                            id="navbarCheckProductQty">
                                                        <input class="form-check-input" type="hidden"
                                                            name="navbar_cart_total"
                                                            value="{{ $item->product->price }}"
                                                            id="navbarCheckProductTotal">
                                                ...
                                                @foreach ($cartItemOutOfStock as $itemOutOfStock)
                                                    ...
                                                    <li style="opacity: 70%;">
                                                        ...
                                                        <div class="content">
                                                            ...
                                                            <p class="quantity">{{ $itemOutOfStock->product_qty }}x -
                ...
                <div class="col-lg-8 col-md-6 col-12">
                    <div class="nav-inner">
                        ...
                        <div class="mega-category-menu" style="border-right: 1px solid #16A085;">
                            @php
                                $category_product = App\Models\ProductCategory::where('is_active', '=', 1)
                                    ->take(15)
                                    ->latest()
                                    ->get();
                            @endphp
