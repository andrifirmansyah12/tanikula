    ...
    <div class="container pt-5 d-flex justify-content-end">
        <div class="dropdown dropstart">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                <li><a class="dropdown-item" onclick="allCategory_maxPrice('{{ url('/product-category/all-category-filtered-max-price') }}')" href="#">Harga Tertinggi</a></li>
                <li><a class="dropdown-item" onclick="allCategory_minPrice('{{ url('/product-category/all-category-filtered-min-price') }}')" href="#">Harga Terendah</a></li>
            </ul>
        </div>
    </div>
