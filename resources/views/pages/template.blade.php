...
<body class="leading-normal tracking-normal text-gray-600" style="font-family: 'Source Sans Pro', sans-serif;">
    ...
    <section class="bg-white py-8">
        <div class="container py-8 px-6 mx-auto">
            <a class="uppercase tracking-wide no-underline hover:no-underline font-bold text-gray-600 text-xl mb-8"
                href="#">
                About
            </a>
            ...
            <p class="mt-8 mb-8">This template is inspired by the stunning nordic minamalist design - in particular:
                <br>
                <a class="text-gray-600 underline hover:text-gray-900" href="http://savoy.nordicmade.com/"
                    target="_blank">Savoy Theme</a> created by <a class="text-gray-600 underline hover:text-gray-900"
                    href="https://nordicmade.com/">https://nordicmade.com/</a> and <a
                    class="text-gray-600 underline hover:text-gray-900" href="https://www.metricdesign.no/"
