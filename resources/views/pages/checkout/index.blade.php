                ...
                <form action="#" method="POST" id="create_orders" accept-charset="utf-8"
                    ...
                    <div class="row">
                        <div class="col-12 col-xl-8 mb-3 mb-xl-0 mb-5 mb-md-0">
                            ...
                            <div class="mb-12 py-3 mt-3"
                                style="border-top: 1px solid #16A085; border-bottom: 1px solid #16A085;"
                                id="product_data">
                                        ...
                                        {{-- @if ($address->count() > 0)
                                            @foreach ($address as $item)
                                                <div class="row align-items-center">
                                                    <div>
                                                        <p class="fw-bold text-black mb-2">{{ $item->recipients_name }}
                                                            <span class="fw-normal">({{ $item->address_label }}) </span>
                                                    ...
                                                    <div class="col-12 mt-2 mt-md-0">
                                                        ...
                                                        <p>
                                                            @if ($item->village_id && $item->district_id && $item->city_id && $item->province_id != null)
                                                                {{ $item->village->name }}, Kecamatan
                                                                {{ $item->district->name }}, {{ $item->city->name }},
                                                                Provinsi {{ $item->province->name }}
                                                            @endif, {{ $item->postal_code }}. [TaniKula
                                                            Note: {{ $item->complete_address }}
                                                            {{ $item->note_for_courier }}].
                                                        </p>
                                                        <p class="pt-3">
                            ...
                            <div class="mt-3">
                                <button type="button" class="btn border btn-warning text-white" data-bs-toggle="modal"
                            ...
                            @if ($cartItem->count() > 0)
                                @foreach ($cartItem as $item)
                                    <input type="hidden" name="cart_id_order[]" value="{{ $item->id }}"
                                        id="checkProductCart">
                                    <div class="mb-12 py-3 mt-3"
                                        style="border-top: 1px solid #16A085; border-bottom: 1px solid #16A085;"
                                        id="product_data">
                                            ...
                                            <div class="page-error">
                                                <div class="page-inner">
                                                    ...
                                                    <div class="mt-3 d-inline-flex">
                                                        <a class="btn w-100 text-uppercase text-white"
                        ...
                        <div class="col-12 col-xl-4">
                            <div class="m-0 m-xl-4 p-4" style="border: 1px solid #16A085;">
                                ...
                                <div class="mb-8 pb-3" style="border-bottom: 1px solid #16A085;">
                                ...
                                <div class="col-12">
                                    @if ($result_cost)
                                        <div>
                                            ...
                                            <div class="p-2 mb-2 rounded" style="border: 1px solid #16A085;">
                                                @foreach ($result_cost as $result)
                                                    @if ($result['service'] == $data_service)
                                                        <input type="hidden" name="priceService"
                                                            value="{{ $result['cost'][0]['value'] }}">
                                                        <div class="px-2">
                                                            <p>{{ $result['service'] }} - {{ $result['description'] }}
                                                                {{ $result['cost'][0]['value'] }}</p>
                                                            <p>({{ $result['cost'][0]['etd'] }} Hari)</p>
                                                        </div>
                                                        <p style="cursor: pointer;" class="px-2 text-end fw-bold"
                                                            data-bs-toggle="modal" data-bs-target="#PilihCourier">Ganti
                                                            Kurir</p>
                                                    @endif
                                                @endforeach
                                            </div>
                                    ...
                                    @else
                                        @if ($address->count() < 1)
                                            <div class="mb-2">
                                                ...
                                                <button disabled style="background: #16A085; color: white"
                                                    class="col-12 btn btn-light border">Pilih Kurir</button>
                                            </div>
                                        @else
                                            @if ($cartItem->count() < 1)
                                                <div class="mb-2">
                                                ...
                                                @else
                                                    @foreach ($address as $item)
                                                        @if ($item->village_id && $item->district_id && $item->city_id && $item->province_id != null)
                                                            <div class="mb-2">
                                                                <label for="courier" class="py-2">Pilih Kurir</label>
                                                                <a style="background: #16A085; color: white"
                                                                    class="d-flex justify-content-center btn btn-light border"
                                                                    data-bs-toggle="modal"
                                                                    data-bs-target="#PilihCourier">Pilih Kurir</a>
                                                            </div>
                                                        @else
                                                            <div class="mb-2">
                                                                <small class="text-danger">*Silahkan lengkapi alamat
                                                                    anda</small><br>
                                                                <label for="courier" class="py-2">Pilih Kurir</label>
                                                                <button disabled style="background: #16A085; color: white"
                                                                    class="col-12 btn btn-light border">Pilih
                                                                    Kurir</button>
                                                            </div>
                                                        @endif
                                                    @endforeach
                                    ...
                                    @endif
                                    @if (!$result_cost)
                                        <button disabled class="btn border col-12"
                                    ...
                                    @else
                                        ...
                                        @else
                                            @if ($cartItem->count() > 0)
                                                <button id="create_orders_btn" type="submit" class="btn border col-12"
                                                    style="background: #16A085; color: white;">
                                                    Buat Pesanan
                                                </button>
                                            @else
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ url('/checkout') }}" method="post">
                        @csrf
                        @foreach ($address as $item)
                            <input type="hidden" name="destination_costumer" id="destination_costumer"
                                value="{{ $item->city_id }}">
                        @endforeach
                        @foreach ($cartItem as $item)
                            <input type="hidden" name="cart_id[]" value="{{ $item->id }}" id="checkProductCart">
                        @endforeach
                        <input type="hidden" name="weight_product" id="weight_product"
                            value="{{ $totalWeightProduct }}">
                        <div class="my-2">
                        ...
                        <div class="form-group mt-5">
                            <h5 class="text-center fw-bold" style="color: #16A085">ESTIMASI</h1>
                                ...
                                <button type="submit" style="background: #16A085; color: white" id="btnDisabled"
                                    disabled class="my-2 border btn btn-light col-12">Simpan</button>
                        </div>
                    </form>
                    {{-- @endif --}}
                </div>
                    ...
                    <form action="#" method="POST" id="edit_employee_form" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="complete_address" id="complete_address" rows="3" id="message-text"></textarea>
                                <div class="invalid-feedback">
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="recipient-name" class="col-form-label">Catatan untuk
                                    kurir:</label>
                                <input type="text" name="note_for_courier" id="note_for_courier"
                                    class="form-control">
                    ...
                    <form action="#" method="POST" id="add_employee_form" accept-charset="utf-8"
                        ...
                        <div>
                            <div class="mb-3">
                                ...
                                <input type="text" name="recipients_name" id="add_recipients_name"
                                    class="form-control">
                                <div class="invalid-feedback">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 ">
                                <div class="col-6">
                                    <label for="recipient-name" class="col-form-label">Label Alamat:</label>
                                    <input type="text" id="add_address_label" name="address_label"
                                        class="form-control border px-3">
                                    <small class="d-flex text-danger pb-1">*Contoh: Rumah, Kantor</small>
                                    <div class="invalid-feedback">
                                    </div>
                                ...
                                <div class="form-group col-6">
                                    ...
                                    @php
                                        ...
                                        $provinces = $provinces->provinces();
                                    @endphp
                                    <select class="form-control border px-3" name="province_id" id="province_id"
                                        required>
                                        <option selected disabled>==Pilih Salah Satu==</option>
                                        @foreach ($provinces as $item)
                                            <option value="{{ $item->id ?? '' }}">{{ $item->name ?? '' }}</option>
                            ...
                            <div class="row mb-3 ">
                                ...
                                <div class="form-group col-6">
                                    <label class="col-form-label" for="kecamatan">Kecamatan</label>
                                    <select class="form-control border px-3" name="district_id" id="district_id"
                                        required>
                                        <option selected disabled>==Pilih Salah Satu==</option>
                                    </select>
                                    <div class="invalid-feedback">
                        ...
                        if (response) {
                            ...
                            $.each(response, function(key, value) {
                                $('select[name="service"]').append('<option value="' +
                                    value.service + '"><strong>' + value.service +
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status == 401) {
                            ...
                            window.location = '/cart/shipment/place-order/received/' + response
                                .id;
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status == 400) {
                            ...
                            showError('add_complete_address', response.messages
                                .complete_address);
