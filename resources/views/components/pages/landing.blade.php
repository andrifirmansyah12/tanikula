...
<body class="leading-normal tracking-normal text-gray-900" style="font-family: 'Source Sans Pro', sans-serif;">
    ...
    <div class="h-screen pb-14 bg-right bg-cover" style="background-image:url('{{ asset('img/bg.svg') }}');">
        ...
        <div class="w-full container mx-auto p-6">
            ...
            <div class="w-full flex items-center justify-between">
                ...
                <div class="flex w-1/2 justify-end content-center">
                    ...
                    <a class="inline-block text-blue-300 no-underline hover:text-indigo-800 hover:text-underline text-center h-10 p-2 md:h-auto md:p-4 text-lg"
                        href="{{ route('login') }}">
                        Login
                    </a>
                </div>
        ...
        <!--Main-->
        <div class="container pt-10 md:pt-16 px-6 mx-auto flex flex-wrap flex-col md:flex-row items-center">

            @yield('content')

            <!--Footer-->
            <div class="w-full pt-16 pb-6 text-sm text-center md:text-left fade-in">
                <a class="text-gray-500 no-underline hover:no-underline" href="#">&copy; Gapoktan Sri Makmur
                    @if(date('Y') == '2022') {{ date('Y') }} @else 2022 - {{ date('Y') }} @endif</a>
            </div>
