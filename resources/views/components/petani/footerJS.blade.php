...
{{-- <script type="text/javascript" src="{{ asset('https://cdnjs.cloudflare.com/ajax/libs/jquery-sparklines/2.1.2/jquery.sparkline.min.js') }}"></script> --}}
...
{{-- <script src="{{ asset('https://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.20/summernote.min.js') }}" integrity="sha512-6rE6Bx6fCBpRXG/FWpQmvguMWDLWMQjPycXMr35Zx/HRD9nwySZswkkLksgyQcvrpYMx0FELLJVBvWFtubZhDQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script> --}}
<script src="{{ asset('stisla/node_modules/chocolat/dist/js/jquery.chocolat.min.js') }}"></script>
{{-- <script src="{{ asset('https://cdnjs.cloudflare.com/ajax/libs/chocolat/1.0.4/js/chocolat.cjs.js') }}" integrity="sha512-KEfZtP6IIP7rvopN8CG9pyei9nAnezFG0DGX+JfUzACpHsJsFNevTmxg3r67hiZ5S42Oxdt2k16q5gWblDoD0A==" crossorigin="anonymous" referrerpolicy="no-referrer"></script> --}}
