        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item">
                        <a href="{{ url('admin/kategori-edukasi') }}" class="nav-link {{ Request::is('admin/kategori-edukasi*') ? 'active' : '' }}">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Edukasi</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ url('admin/kategori-kegiatan') }}" class="nav-link {{ Request::is('admin/kategori-kegiatan*') ? 'active' : '' }}">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Kegiatan</p>
                        </a>
                    </li>
            ...
            <li class="nav-item">
                <a href="{{ url('admin/edukasi') }}" class="nav-link {{ Request::is('admin/edukasi*') ? 'active' : '' }}">
            ...
            <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="{{ url('admin/daftar-gapoktan') }}" class="nav-link {{ Request::is('admin/daftar-gapoktan*') ? 'active' : '' }}">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Gapoktan</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ url('admin/daftar-poktan') }}" class="nav-link {{ Request::is('admin/daftar-poktan*') ? 'active' : '' }}">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Poktan</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ url('admin/daftar-petani') }}" class="nav-link {{ Request::is('admin/daftar-petani*') ? 'active' : '' }}">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Petani</p>
                        </a>
                    </li>
            ...
            <li class="nav-item">
                <a href="{{ url('admin/tandur') }}" class="nav-link {{ Request::is('admin/tandur*') ? 'active' : '' }}">
            ...
            <li class="nav-item">
                <a href="{{ url('admin/panen') }}" class="nav-link {{ Request::is('admin/panen*') ? 'active' : '' }}">
            ...
            <li class="nav-item">
                <a href="{{ url('admin/rekap-penjualan') }}" class="nav-link {{ Request::is('admin/rekap-penjualan*') ? 'active' : '' }}">
