                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body pt-4 px-4">
                            <h4 class="border p-3 text-center rounded">Biodata Petani</h4>
                        </div>
                    ...
                    <div class="card mb-4">
                        <div class="card-body text-center">
                            ...
                            <img alt="image" id="image_preview" src="../storage/profile/{{ $userInfo->image }}"
                                ...
                                style="width: 150px; height: 150px; -o-object-fit: cover; object-fit: cover; -o-object-position: center; object-position: center;"">
                                @endif
                                <h5 class=" my-3">{{ $userInfo->user->name }}</h5>
                            <p class="text-muted mb-4">Akun Petani</p>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0">{{ $userInfo->gapoktan->user->name }} dan {{ $userInfo->poktan->user->name }}</p>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                        ...
                        <div class="card-footer row align-items-center justify-content-end mb-3">
                            ...
                            <input type="button" value="Ubah Biodata Petani" class="btn btn-primary shadow-none m-1"
