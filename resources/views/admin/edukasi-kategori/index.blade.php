...
@section('script')
    ...
    <script>
        $('.nameCheck').change(function(e) {
            $.get('{{ route('admin-kategoriEdukasi-checkSlug') }}',
            { 'name': $(this).val() },
                function( data ) {
        ...
        $(function() {
            ...
            $("#add_employee_form").submit(function(e) {
                ...
                $.ajax({
                url: '{{ route('admin-kategoriEdukasi-store') }}',
                method: 'post',
                data: fd,
                cache: false,
                contentType: false,
            ...
            $(document).on('click', '.editIcon', function(e) {
                ...
                let id = $(this).attr('id');
                $.ajax({
                url: '{{ route('admin-kategoriEdukasi-edit') }}',
                method: 'get',
                data: {
                    id: id,
                    _token: '{{ csrf_token() }}'
            ...
            $("#edit_employee_form").submit(function(e) {
                ...
                $.ajax({
                url: '{{ route('admin-kategoriEdukasi-update') }}',
                method: 'post',
                data: fd,
                cache: false,
                contentType: false,
            ...
            function fetchAllEmployees() {
                $.ajax({
                url: '{{ route('admin-kategoriEdukasi-fetchAll') }}',
                method: 'get',
                success: function(response) {
