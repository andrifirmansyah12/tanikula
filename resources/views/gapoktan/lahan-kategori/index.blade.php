    ...
    <script>
        ...
        $(function() {
            ...
            $("#add_employee_form").submit(function(e) {
                ...
                $.ajax({
                url: '{{ route('gapoktan-kategoriLahan-store') }}',
                method: 'post',
                data: fd,
                cache: false,
                contentType: false,
            ...
            $(document).on('click', '.editIcon', function(e) {
                ...
                let id = $(this).attr('id');
                $.ajax({
                url: '{{ route('gapoktan-kategoriLahan-edit') }}',
                method: 'get',
                data: {
                    id: id,
                    _token: '{{ csrf_token() }}'
            ...
            $("#edit_employee_form").submit(function(e) {
                ...
                $.ajax({
                url: '{{ route('gapoktan-kategoriLahan-update') }}',
                method: 'post',
                data: fd,
                cache: false,
                contentType: false,
            ...
            function fetchAllEmployees() {
                $.ajax({
                url: '{{ route('gapoktan-kategoriLahan-fetchAll') }}',
                method: 'get',
                success: function(response) {
