                            ...
                            <article class="article article-style-b shadow-none">
                                <div class="article-header">
                                    ...
                                    <div class="article-badge">
                                        <div class="article-badge-item bg-danger" id="category_activity_gapoktan">
                                ...
                                <div class="article-details">
                                    <div class="m-0 row justify-content-between">
                                        <div id="user_id_gapoktan" style="font-weight: bold">

                                        </div>
                                        <div id="date_activity_gapoktan">

                                        </div>
                                    </div>
                                    <div class="article-title">
                                        <div id="title_activity_gapoktan" class="mt-3 text-capitalize">
    ...
    <script>
        ...
        $(function() {
            ...
            $(document).on('click', '.showDraftActivity', function(e) {
                ...
                let id = $(this).attr('id');
                $.ajax({
                url: '{{ route('gapoktan-kegiatan-showActivity') }}',
                method: 'get',
                data: {
                    id: id,
                    _token: '{{ csrf_token() }}'
                ...
                success: function(response) {
                    $("#title_activity_gapoktan").html(`
                        <h6 class="text-capitalize">
                            ${response.title}
                        </h6>
                    `);
                    $("#category_activity_gapoktan").html(`
                        <i class="bi bi-bookmark"></i> ${response.activity_category.name}
                    `);
                    $("#user_id_gapoktan").html(`
                        <span>
                            Dibuat oleh
                            ${response.user.name}
                        </span>
                    `);
                    $("#date_activity_gapoktan").html(`
                        <span>
                            <i class="bi bi-calendar"></i>
                            ${moment(response.date).locale('id').format('DD MMM YYYY')}
                        </span>
                    `);
                    $("#desc_activity_gapoktan").html(`
            ...
            function fetchAddActivity() {
                $.ajax({
                url: '{{ route('gapoktan-kegiatan-fetchAddActivity') }}',
                method: 'get',
                success: function(response) {
            ...
            function fetchDraftActivity() {
                $.ajax({
                url: '{{ route('gapoktan-kegiatan-fetchDraftActivity') }}',
                method: 'get',
                success: function(response) {
