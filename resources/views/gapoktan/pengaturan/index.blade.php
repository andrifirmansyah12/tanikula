...
@section('title', 'Biodata Gapoktan')
...
@section('content')
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Ubah Biodata Gapoktan</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <script>
        ...
        $(function() {
            $("#image").change(function(e) {
                ...
                $.ajax({
                    url: '{{ route('gapoktan.pengaturan.image') }}',
                    method: 'POST',
                    data: fd,
                    cache: false,
                    processData: false,
            ...
            $("#profile_form").submit(function(e) {
                ...
                $.ajax({
                    url: '{{ route('gapoktan.pengaturan.update') }}',
                    method: 'POST',
            ...
            $("#editPasswordForm").submit(function(e) {
                ...
                $.ajax({
                    url: '{{ route('gapoktan.pengaturan.updatePassword') }}',
                    method: 'POST',
                    data: $(this).serialize()+ `&id=${id}`,
                    dataType: 'json',
                    success: function(res){
