...
@section('script')
    ...
    <script>
        ...
        title.addEventListener('change', function() {
            fetch('/gapoktan/edukasi/checkSlug?title=' + title.value)
        ...
        $(function() {
            ...
            $("#add_employee_form").submit(function(e) {
                ...
                $.ajax({
                url: '{{ route('gapoktan-edukasi-store') }}',
                method: 'post',
                data: fd,
                cache: false,
                contentType: false,
            ...
            $(document).on('click', '.editIcon', function(e) {
                ...
                let id = $(this).attr('id');
                $.ajax({
                url: '{{ route('gapoktan-edukasi-edit') }}',
                method: 'get',
                data: {
                    id: id,
                    _token: '{{ csrf_token() }}'
            ...
            $("#edit_employee_form").submit(function(e) {
                ...
                $.ajax({
                url: '{{ route('gapoktan-edukasi-update') }}',
                method: 'post',
                data: fd,
                cache: false,
                contentType: false,
            ...
            $(document).on('click', '.deleteIcon', function(e) {
                ...
                if (result.isConfirmed) {
                    $.ajax({
                    url: '{{ route('gapoktan-edukasi-delete') }}',
                    method: 'delete',
                    data: {
                        id: id,
                        _token: csrf
            ...
            function fetchAllEmployees() {
                $.ajax({
                url: '{{ route('gapoktan-edukasi-fetchAll') }}',
                method: 'get',
                success: function(response) {
