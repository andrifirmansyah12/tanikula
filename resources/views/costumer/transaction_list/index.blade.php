            ...
            <div class="card my-4" id="tabs">
                ...
                <div class="card-body px-0 pb-2">
                    <ul class="mx-3 p-1 nav bg-light rounded nav-fill">
                        <li class="nav-item">
                            <a class="nav-link bg-gradient-primary rounded text-white" href="#listSemua">Semua</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#listDikemas">Dikemas</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#listDikirim">Dikirim</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#listSelesai">Selesai</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#listDibatalkan">Dibatalkan</a>
                        </li>
                    </ul>
